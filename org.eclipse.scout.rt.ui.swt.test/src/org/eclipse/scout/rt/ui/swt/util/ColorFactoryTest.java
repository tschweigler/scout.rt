...
public class ColorFactoryTest {
  ...
  /**
   * Test method for {@link org.eclipse.scout.rt.ui.swt.util.ColorFactory#getColor(org.eclipse.swt.graphics.RGB)}.
   */
  @Test
  ...
  /**
   * Test method for {@link org.eclipse.scout.rt.ui.swt.util.ColorFactory#getColor(java.lang.String)}.
   */
  @Test
  ...
  private void runGetColorString(String scoutColor, int red, int green, int blue) {
    Color color = m_colorFactory.getColor(scoutColor);
    assertColorEquals(red, green, blue, color);
  }

  private static void assertColorEquals(int red, int green, int blue, Color color) {
