 ...
 * <ul>
 * <li>All methods annotated with {@link BeforeClass} are executed in the same
 * Scout transaction</li>
 * <li>All methods annotated with {@link Before} or {@link After} are executed
 * in the same Scout transaction as the test method itself (i.e. the one
 * annotated with {@link Test}).</li>
 * <li>All methods annotated with {@link AfterClass} are executed in the same
 * Scout transaction</li>
 * </ul>
 */
